...
<head>
    ...
    <link rel="stylesheet" href="assetsr/fonts/font-awesome.min.css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Bitter:400,700">
    <link rel="stylesheet" href="assetsr/css/Forum---Thread-listing-1.css">
    <link rel="stylesheet" href="assetsr/css/Forum---Thread-listing.css">
    <link rel="stylesheet" href="assetsr/css/Header-Dark.css">
    <link rel="stylesheet" href="assetsr/css/styles.css">
</head>
<%
...
<body>
    <div class="media"></div>
    <div>
        <div class="header-dark" style="background-image: url(&quot;assetsr/img/back.jpg&quot;);">
            ...
            <div class="col-md-12">
                ...
                <div>
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" role="tab" data-toggle="tab" href="#tab-1">Followers<span class="badge badge-pill badge-primary"><%= numOffol%></span></a></li>
                        ...
                        <div class="tab-pane active" role="tabpanel" id="tab-1">
                            ...
                            <ul class="thread-list">
                                ...
                                <li class="thread" >
                                    ...
                                    <input type ="submit" id="id" value = <%= foll.getId()%>>
